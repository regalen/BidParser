...
class User(Base):
    ...
    default_vendor: Mapped[str | None] = mapped_column(String(64), nullable=True)
    fx_rate_pegged: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, server_default="0")
    fx_rate: Mapped[Decimal | None] = mapped_column(Numeric(12, 4), nullable=True)
    fx_rate_updated_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
