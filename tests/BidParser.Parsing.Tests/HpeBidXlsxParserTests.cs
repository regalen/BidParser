...
public sealed class HpeBidXlsxParserTests
{
    ...
    // ── File 1: 9500000001 — 66 items (Bundle × 3, BundleDetails × 63) ──
    ...
    public void File1_Metadata_IsCorrect()
    {
        ...
        result.Metadata.QuoteNumber.Should().Be("9500000001");
    ...
    // ── File 2: 9500000002 — 4 Part Number rows only ──

    [Fact]
    public void File2_Metadata_IsCorrect()
    {
        var result = Parse("HPE_Deal_9500000002_v1.xlsx");

        result.Metadata.QuoteNumber.Should().Be("9500000002");
        result.Metadata.Currency.Should().Be("AUD");
        result.Metadata.QuotedTotal.Should().BeNull();
    }
