...
public sealed class HpGlobalBidXlsxParserTests
{
    ...
    private static string SamplePath() =>
        Path.Combine(TestSample.Root, "samples", "inputs", "translate_quote_98000001_v25_all.xlsx");
    ...
    public void Metadata_IsCorrect()
    {
        ...
        result.Metadata.QuoteNumber.Should().Be("98000001");
    ...
    public void FirstFiveItems_HaveCorrectFields()
    {
        ...
        // Qty is always 1 (the source "Aggregated item quantity" is not used).
        result.LineItems
            .Take(5)
    ...
    public void Comments_RemainingOnly_EvenWhenTermPresent()
    {
        ...
        // 8X223AA has a Full term (Months) value, but the term is not parsed —
    ...
    public void Comments_NeverContainTermOrPipe()
    {
        ...
        // Full term (Months) is not parsed, so no comment carries a term or pipe.
