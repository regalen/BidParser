...
/// <summary>
/// On startup, seeds the initial admin user from <see cref="AppOptions"/> when the users table is empty
/// (with must-change-password set). Tolerates a concurrent seeder via the unique-username constraint, and
