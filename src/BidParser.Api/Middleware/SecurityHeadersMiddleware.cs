...
/// <summary>
/// Adds security response headers to every response: nosniff, DENY framing, no-referrer, a strict
/// Content-Security-Policy for the self-hosted SPA, and HSTS on HTTPS. Registered via UseSecurityHeaders().
/// </summary>
...
/// <summary>Pipeline helper to register <see cref="SecurityHeadersMiddleware"/>.</summary>
