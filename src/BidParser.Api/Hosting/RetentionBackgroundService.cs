...
/// <summary>
/// Background loop that runs <see cref="RetentionService"/> once at startup and then every 24h
/// (cleanup-first, so frequent restarts don't starve it), purging parse jobs/failures and their files
/// older than RETENTION_DAYS. Failures are logged and the loop continues.
/// </summary>
