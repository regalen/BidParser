...
/// <summary>Shared helpers for the endpoint groups: safe JSON body reading, resolving the current user from claims, and a 400 error result.</summary>
...
/// <summary>Result of reading a JSON body: either a parsed <c>Value</c> or an <c>Error</c> message.</summary>
