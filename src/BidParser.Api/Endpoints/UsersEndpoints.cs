...
/// <summary>
/// Admin user-management CRUD under /api/users (Admin policy; writes are CSRF-guarded): list, create,
/// update (PATCH /{userId}) and delete. Create/reset generate a one-time temporary password returned once
