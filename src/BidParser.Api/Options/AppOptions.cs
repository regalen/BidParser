...
/// <summary>
/// Strongly-typed application configuration, loaded from environment variables via
/// <see cref="FromConfiguration"/> (with dev-only fallbacks) and registered as a singleton. Note the
/// production guard: FORWARDED_ALLOW_IPS must be an explicit proxy-IP allowlist, never "*".
/// </summary>
