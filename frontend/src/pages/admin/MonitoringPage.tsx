...
const statusOptions = [
  ...
  { value: 'validationMismatch', label: 'Validation mismatch' },
  { value: 'magicByteMismatch', label: 'Magic-byte mismatch' },
  { value: 'parserError', label: 'Parser error' },
  { value: 'unhandledException', label: 'Unhandled exception' },
];
...
export function MonitoringPage() {
  ...
  const queryKey = useMemo(() => {
    ...
    for (const key of ['range', 'from', 'to', 'vendor', 'userId', 'parserSlug', 'status', 'importType']) {
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-6 py-8 lg:px-8">
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href={`/api/monitoring/runs/export?${(() => {
