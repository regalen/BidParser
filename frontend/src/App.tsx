...
import { DellApiSettingsPage } from './pages/admin/DellApiSettingsPage';
import { MetricsDashboard } from './pages/admin/MetricsDashboard';
import { MonitoringPage } from './pages/admin/MonitoringPage';
import { UsersPage } from './pages/admin/UsersPage';
import { RuntimeConfigurationPage } from './pages/admin/RuntimeConfigurationPage';
...
export function App() {
  ...
  return (
    <Routes>
      <Route path="/login" element={user ? <Navigate to={user.mustChangePassword ? '/change-password' : '/dashboard'} replace /> : <LoginPage />} />
      <Route path="/change-password" element={user ? <ChangePasswordPage /> : <Navigate to="/login" replace />} />
      <Route
        path="/dashboard"
        element={user ? (user.mustChangePassword ? <Navigate to="/change-password" replace /> : <DashboardPage />) : <Navigate to="/login" replace />}
      />
      
      {/* Admin Shell Routes */}
      <Route path="/settings" element={<Navigate to="/admin/users" replace />} />
      <Route path="/admin/users" element={<AdminRoute><UsersPage /></AdminRoute>} />
      <Route path="/admin/dell-api" element={<AdminRoute><DellApiSettingsPage /></AdminRoute>} />
      ...
      <Route path="/admin/runtime-config" element={<AdminRoute><RuntimeConfigurationPage /></AdminRoute>} />
