...
export function DellApiErrorModal({ message, onClose }: Props) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div
        role="alertdialog"
        aria-modal="true"
        aria-labelledby="dell-api-err-title"
        aria-describedby="dell-api-err-body"
      ...
      >
        <div className="flex items-center gap-3 rounded-t-xl bg-red-50 px-6 py-4 border-b border-red-200">
          ...
          <span id="dell-api-err-title" className="text-base font-bold text-red-800 uppercase tracking-wide">
            Dell Quote Unavailable
          </span>
        </div>

        <div className="px-6 py-5">
          <p id="dell-api-err-body" className="text-sm leading-6 text-slate-700">
            {message}
          </p>
        </div>
