...
Canonical project reference for all AI agents (Antigravity, Claude Code, etc.) working in this repository.
This file is kept lean: build/test commands, core architecture principles, state-tracking rules, and
...
`dotnet test BidParser.sln` (267: 178 parsing + 89 API integration). API tests
...
- `dotnet test BidParser.sln` — full suite (267 tests; API tests need Docker).
