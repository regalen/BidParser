...
- Current checkpoint: working branch is `dotnet-refactor`, pushed separately from `main`. No PR is open. Next implementation phase is Phase 11 (workbook writer parity / golden output regression).
