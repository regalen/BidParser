...
- Current checkpoint: working branch is `dotnet-refactor`, pushed separately from `main`. No PR is open. Next implementation phase is Phase 14 (cutover: delete Python backend, update docs).
